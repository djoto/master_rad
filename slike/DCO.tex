...
\begin{tikzpicture}[scale=0.95]
    ...
    (rc1) ++ (0,0.5) node[](rc2){}
    (rc4) ++ (0,0.5) node[](rc3){}
    ($(rc1)!0.5!(rc4)$) node[anchor=south, scale=0.8, text=\CtrlDecColor]{Column Control};
    ...
    (rr1) ++ (-0.5,0) node[](rr2){}
    (rr4) ++ (-0.5,0) node[](rr3){}
    ($(rr1)!0.5!(rr4)$) node[anchor=north, scale=0.8, rotate=-90, text=\CtrlDecColor]{Row Control};
    ...
    \foreach \i in {0,1,2,3,4} {
        ...
        (ph\i.east) node[anchor=west, scale=0.8]{Phase \i};
    }
\end{tikzpicture}
