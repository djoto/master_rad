\begin{figure}[!ht]
    ...
    % P substrate
    \node[draw, rectangle, fill=red!20, minimum height=3cm, minimum width=15cm, inner sep=0] (psub) at (0,-1.5) {};
    ...
    \draw[fill=yellow!60] (3.5,0) rectangle (4.5,-0.5); % NMOS source
    \node[draw, rectangle, fill=yellow!60, minimum height=0.5cm, minimum width=1cm, inner sep=0] (nsource) at (4.0,-0.25) {\scriptsize n\,\tiny $+$};
    \draw[fill=yellow!60] (5.5,0) rectangle (6.5,-0.5); % NMOS drain
    \node[draw, rectangle, fill=yellow!60, minimum height=0.5cm, minimum width=1cm, inner sep=0] (ndrain) at (6.0,-0.25) {\scriptsize n\,\tiny $+$};
    ...
    \node[draw, rectangle, fill=red!60, minimum height=0.5cm, minimum width=1cm, inner sep=0] (ptap) at (2,-0.25) {\scriptsize p\tiny $+$\,\scriptsize tap};
    ...
    \draw[decoration={brace},decorate] (1,1.7) -- node[above=1pt] {\scriptsize NMOS} (7,1.7);
    % Labels
    \draw (nwell.south west) ++ (0.08,0.08) node[anchor=south west] {\scriptsize N-Well};
    \draw (psub.south) ++ (0.1,0.1) node[anchor=south] {\scriptsize P-Substrate};
