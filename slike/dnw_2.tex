\begin{figure}[!ht]
    ...
    %\vspace{0.5cm}
    \caption{Попречни пресјек CMOS инвертора са NMOS транзистором изолованим коришћењем дубоке јаме N типа \engl{Deep N-Well} и додатим заштитним прстеном повезаним на $V_\text{SS}$.}
